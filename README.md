...
| discordMessageFormat           | `[Necesse] **<author>**: <message>` | Format of messages sent to Discord                           |
| discordConnectMessageFormat    | `[Necesse] _<player> has joined_`   | Format of messages sent to Discord when a player connects    |
| discordDisconnectMessageFormat | `[Necesse] _<player> has left_`     | Format of messages sent to Discord when a player disconnects |
| necesseMessageFormat           | `[§8Discord§0] <author>: <message>` | Format of messages sent to Necesse                           |

Messages sent to Discord support standard Discord markdown.
Messages sent within Necesse support Necesse markdown (color codes, items, etc.).
